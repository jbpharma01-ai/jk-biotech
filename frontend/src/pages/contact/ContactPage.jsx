...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitError(err.message || 'Failed to submit enquiry. Please check your inputs and try again.');
    } finally {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="rounded-3xl border border-orange-100 bg-white p-6 md:p-8 shadow-[0_10px_40px_rgba(249,115,22,0.08)]">
              ...
              {submitSuccess && (
                <div className="mt-4 rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm font-medium text-green-700 flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600 flex-shrink-0" />
                  <span>Thank you! Your message has been submitted successfully to J K BIOTECH.</span>
                </div>
              )}
